		...
		echo $this->form->dropDownList(
			...
			array(
				...
				'ajax' => array(
					...
					'url' => $this->dimensionType === self::SIZE_ONLY ? Yii::app()->createUrl('zoomproduct/default/getmatrixproduct') : Yii::app()->createUrl('product/getcolors'),
			...
			array(
				...
				'ajax' => array(
					...
					'data' => 'js:{"' .
						...
						'id' . '": ' . $model->id .
						'}',
					'url' => Yii::app()->createUrl('zoomproduct/default/getmatrixproduct'),
